<div align="center">
  <h1>FAN-CE UI</h1>
  <p>A Multi-Framework Admin Dashboard Proof of Concept</p>
</div>
...
FAN-CE UI 是一个现代化的 Vue 3 + TypeScript monorepo 前端框架项目，旨在提供完整的企业级前端开发解决方案。项目采用最新的前端技术栈，支持多种主流 UI 组件库，提供从开发到部署的完整工具链和最佳实践。
...
#### 🚀 **Web-Element** (`/apps/web-ele/`)
基于 Element Plus 的管理后台：
- **Vue 3** + **TypeScript**
- **Element Plus** UI 框架
- 与其他应用共享核心功能

#### 💎 **Web-Naive** (`/apps/web-naive/`)
基于 Naive UI 的现代化界面：
- **Vue 3** + **TypeScript**
- **Naive UI** 组件库
- 统一的架构设计
