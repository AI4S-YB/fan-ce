...
class MD5Hashing implements Hashing {
  ...
  public static getInstance(): MD5Hashing {
    if (!MD5Hashing.instance) MD5Hashing.instance = new MD5Hashing();
...
class SHA256Hashing implements Hashing {
  ...
  public static getInstance(): SHA256Hashing {
    if (!SHA256Hashing.instance) SHA256Hashing.instance = new SHA256Hashing();
...
class SHA512Hashing implements Hashing {
  ...
  // 获取单例实例
  public static getInstance(): SHA256Hashing {
    if (!SHA512Hashing.instance) SHA512Hashing.instance = new SHA512Hashing();
