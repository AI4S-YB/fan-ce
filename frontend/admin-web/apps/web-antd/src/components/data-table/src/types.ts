...
export interface DataTableEmits {
  ...
  /** 双击单元格事件 */
  cellDoubleClick: [rowIndex: number, columnIndex: string, record: TableDataItem];
  /** 双击表头事件 */
  headerDoubleClick: [columnIndex: string, column: ColumnConfig];
  /** 行选择变化 */
  selectionChange: [
    selectedRowKeys: (number | string)[],
