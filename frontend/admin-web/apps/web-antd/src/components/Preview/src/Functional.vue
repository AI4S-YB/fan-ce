...
import { CloseOutlined, LeftOutlined, RightOutlined } from '#/utils/antdAll';
...
export default defineComponent({
  ...
  setup(props, { expose, emit }) {
    ...
    const getScaleStep = computed(() => {
      ...
      return (scaleStep ?? scaleStep < 100)
        ? scaleStep / 100
        : imgState.imgScale / 10;
    });
    ...
    function handleAddMoveListener(e: MouseEvent) {
      ...
      const imgEl = unref(imgElRef);
      if (imgEl) imgEl.addEventListener('mousemove', moveFunc);
    }
