...
import type {
  TransferDirection,
  TransferItem,
} from 'ant-design-vue/lib/transfer';
...
const getTargetKeys = computed<string[]>(() => {
  ...
  if (Array.isArray(props.targetKeys)) return props.targetKeys;
...
async function fetch() {
  ...
  if (!api || !isFunction(api)) {
    if (Array.isArray(props.dataSource)) _dataSource.value = props.dataSource;
