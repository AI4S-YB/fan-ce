...
class TestGwasAssembly:
    def test_check_analysis_readiness_returns_traffic_light(self, db_session):
        ...
        ds_v = Dataset(dataset_code="DS_READY_V", dataset_type="variome", )
        ds_p = Dataset(dataset_code="DS_READY_P", dataset_type="phenome", )
    ...
    def test_assemble_gwas_input_empty_when_no_samples(self, db_session):
        ...
        ds_v = Dataset(dataset_code="DS_GWAS_V", dataset_type="variome", )
        ds_p = Dataset(dataset_code="DS_GWAS_P", dataset_type="phenome", )
        db_session.add_all([ds_v, ds_p])
        db_session.commit()
