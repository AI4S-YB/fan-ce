...
class TestLineageConstraints:
    ...
    def test_invalid_relation_type_is_rejected(self):
        ...
        from apps.datasets.services import DatasetDomainService, validate_lineage_relation_type
    ...
    def test_valid_relation_types_are_accepted(self):
        ...
        from apps.datasets.services import validate_lineage_relation_type
